...
The instructions and questions for completing the lab using python can be found here:

https://github.com/JamesOwers/iaml2017/blob/master/04_Lab_2_Decision_trees_linear_regression.ipynb

Any instructions in **bold** are copied from James' instructions in the above link.

These are my solutions using R. 
